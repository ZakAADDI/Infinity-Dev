<template>
  <AppLayout>
    <Head title="À propos — Infinity Dev"
      :meta="[
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 mb-12">
          <div class="text-center mb-8">
            <div class="w-32 h-32 bg-gradient-to-r from-violet-500 to-blue-500 rounded-full mx-auto mb-6 flex items-center justify-center">
              <img src="/public/assets/images/image-profil.png" alt="Portrait de Zakaria AADDI, fondateur d’Infinity Dev" loading="lazy">
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-3">
                ...
                <span class="px-4 py-2 bg-violet-100 text-violet-800 rounded-full text-sm font-medium">Tailwind CSS</span>
              </div>
            </div>
